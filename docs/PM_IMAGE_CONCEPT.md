# PM Plan Image Storage Concept

คอนเซปการเก็บรูปภาพของเมนู `แผน PM`:

1. ผู้ใช้เลือกรูปในฟอร์มแผน PM
2. เว็บส่งรูปไป `/api/drive-upload`
3. API ส่งต่อไป Google Apps Script Web App
4. Apps Script สร้างไฟล์ใน Google Drive ใต้โฟลเดอร์ `TextileOps Uploads/ประวัติเช็คศูนย์`
5. Apps Script ส่งลิงก์กลับมาเป็น `url` และ `webViewLink`
6. เว็บเก็บลิงก์ลงฟิลด์ `ImageUrl`
7. ตารางแผน PM แสดงคอลัมน์ `URL` และ `รูป`
